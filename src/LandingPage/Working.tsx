    ...
    <div className="mt-20 pb-5">
      ...
      <div className="flex px-16 justify-between items-center">
        <div className="relative">
          <img className="w-[30rem]" src="src/assets/girl.png" alt="girl" />
          <div className="w-36 top-[15%] right-0 absolute flex flex-col items-center gap-1 border border-bright-sun-400 rounded-xl py-3 px-1 backdrop-blur-md">
            <Avatar className="!h-16 !w-16" src="src/assets/avatar.png" alt="it's me" />
          ...
          {works.map((work, index) =>
            <div key={index} className="flex items-center gap-4">
              <div className="p-2.5 bg-bright-sun-300 rounded-full">
                <img className="w-12 h-12" src={`src/assets/Works/${work.name}.png`} alt="" />
              </div>
              <div>
