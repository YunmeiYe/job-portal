...
const Working = () => {
  return (
    <div className="mt-20 pb-5">
      ...
      <div className="text-lg sm-mx:text-base xsm-mx:text-sm text-mine-shaft-300 text-center mx-auto mb-10 sm-mx:w-11/12">
        ...
        <div className="flex flex-col gap-10">
          {works.map((work, index) =>
            <div key={index} className="flex items-center gap-4">
              ...
              <div>
                <div className="text-mine-shaft-200 text-xl md-mx:text-lg sm-mx:text-base font-semibold">{work.name}</div>
                <div className="text-mine-shaft-300 md-mx:text-base sm-mx:text-sm">{work.desc}</div>
              </div>
            </div>
          )}
        </div>
