...
const Sort = (props: any) => {
  ...
  return (
    ...
    >
      <Combobox.Target>
        <div className='border border-bright-sun-400 flex gap-2 px-2 pr-1 py-1 text-sm rounded-xl items-center cursor-pointer hover:bg-mine-shaft-900' onClick={() => combobox.toggleDropdown()}>
          {selectedItem}
