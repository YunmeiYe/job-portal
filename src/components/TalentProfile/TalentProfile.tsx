    ...
    <div className="w-2/3 lg-mx:w-full">
      <div className="relative">
        ...
        <div className="flex items-center justify-center -bottom-1/3 md-mx:-bottom-10 sm-mx:-bottom-16 absolute left-6">
          <Avatar className="!w-48 !h-48 md-mx:!w-40 md-mx:!h-40 sm-mx:!w-36 sm-mx:!h-36 xs-mx:!w-32 xs-mx:!h-32 rounded-full border-mine-shaft-950 border-8" src={profile.picture ? `data:image/jpeg;base64, ${profile.picture}` : "/assets/avatar.png"} />
        </div>
      </div>
